...
extern void TIMER_ClearUsbSendTimeout();
extern bool TIMER_IsUsbSendTimeout();
        ...
        for (int i = 0; i < length;) {
            ...
            if (n) {
                ...
                if (!stdio_usb_connected() ||
                    ...
                    (!tud_cdc_write_available() && TIMER_IsUsbSendTimeout())) { // 送信タイムアウトした場合
                    // <=====
                    break;
                }
            }
